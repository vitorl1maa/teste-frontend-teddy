...
import { LucideAngularModule, Plus, Minus, Trash2, Pencil, X, AlignJustify, ArrowLeft } from 'lucide-angular';
...
export class IconComponent implements OnChanges {
  @Input() icon: "minus" | "trash2" | "pencil" | "x" | "alignJustify" | "arrowLeft" | "plus" = "plus"
